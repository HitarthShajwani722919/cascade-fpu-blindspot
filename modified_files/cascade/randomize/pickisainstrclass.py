...
ISAINSTRCLASS_INITIAL_BOOSTERS = {
    ...
    ISAInstrClass.MEMFPU:      0.4,
    ISAInstrClass.FPU:         0.4,
    ISAInstrClass.FPU64:       0.4,
    ISAInstrClass.MEMFPUD:     0.5,
    ISAInstrClass.FPUD:        0.4,
    ISAInstrClass.FPUD64:      0.4,
